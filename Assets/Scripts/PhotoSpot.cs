...
public class PhotoSpot : MonoBehaviour
{
        ...
        if (transform.childCount >= 1)
        {
            ...
            else
            {
                if (canvas == null)
                {
                    ...
                    questNameText = InstantiateText("Quest Name", 6, new Vector3(0, 0.32f, 0));
                    questHintText = InstantiateText("Quest Hint", 4, new Vector3(0, 0.18f, 0));
                    questCompletedText = InstantiateText("Quest Complete Status", 4, new Vector3(0, -0.12f, 0));
                }
            }
    ...
    TextMeshProUGUI InstantiateText(string text, int fontSize, Vector3 position)
    {
        ...
        textObject.rectTransform.sizeDelta = new Vector2(40, 25);
